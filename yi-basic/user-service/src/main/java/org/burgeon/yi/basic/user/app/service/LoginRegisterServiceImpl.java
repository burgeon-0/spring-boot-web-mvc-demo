...
public class LoginRegisterServiceImpl implements LoginRegisterService {
    ...
    @Override
    public void loginByMobileVerificationCode(LoginByMobileVerificationCodeRequest request) throws ValidationException {
    ...
    @Override
    public void registerByMobileVerificationCode(RegisterByMobileVerificationCodeRequest request) throws ValidationException {
